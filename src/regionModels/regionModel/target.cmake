...
add_library(libregionModels ${SOURCES})
set_target_properties(libregionModels PROPERTIES PREFIX "")

target_link_libraries(libregionModels ${LIBRARIES})

install(TARGETS libregionModels DESTINATION lib OPTIONAL)
