...
if(NOT BOOST_THREAD_LIBRARY OR NOT BOOST_INCLUDE_DIR)
  ...
  if(NOT BOOST_THREAD_LIBRARY)
    message(SEND_ERROR "Can not locate BOOST_THREAD library")
  endif()    

endif()

find_package_handle_standard_args(BOOST_THREAD
  DEFAULT_MSG
